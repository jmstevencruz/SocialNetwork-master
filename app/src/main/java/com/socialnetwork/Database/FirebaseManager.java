...
import static com.socialnetwork.Activities.ProfileActivity.setData;
...
public class FirebaseManager {
    ...
    static SkillsObj skills = new SkillsObj();
    static ArrayList<GroupObj> arrayGroup = new ArrayList<>();
    static ArrayList<SkillsObj> arraySkills = new ArrayList<>();
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            try {
                                ...
                                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                    ...
                                    skills.setCode(snapshot.getKey());
                                    skills.setName(snapshot.getValue().toString());
